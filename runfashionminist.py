...
from minist import get_fashionmnist_unorderData 
from minist import fashionmnist_test_data 
...
if __name__ =='__main__':
    ...
    clis=[]
    data_idx,dataset =  get_fashionmnist_unorderData(config['alpha'],config['clientnum'])
    wandb.init(
    ...
    test_dataset = fashionmnist_test_data()
